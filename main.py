...
# TODO: исправить, что Дон убивает и проверяет одновременно
# TODO: и вообще Дон ебанутый получился
# TODO: Убийство должно происходить при смене ночи и дня
